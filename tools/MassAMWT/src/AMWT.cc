...
//    else anaEL.LoadAnalysisInfo("MassAnalysis", "NbrJetSmearMC", nbrJetSmear);
  ...
  massSolver= new MassSolver();
   ...
   //PDF initialization
// fixme
  string lhapdfFile("/data1/speer/topmass/cmssw/lhapdf585_64/share/lhapdf/PDFsets/cteq61.LHgrid");
//   anaEL.LoadAnalysisInfo("LHAPDF", "file", lhapdfFile);
  ...
  string JR_Standalone_Path("/data1/speer/tblsm/tools/JR_Standalone/JetMETObjects/data/");
