...
!      imem=member(iset)                                                
      ...
      call jeppe2(imem,xlog,qsqlog,nx,nq,xxl,qql,cc1,upv,iset) 
      call jeppe2(imem,xlog,qsqlog,nx,nq,xxl,qql,cc2,dnv,iset) 
      call jeppe2(imem,xlog,qsqlog,nx,nq,xxl,qql,cc3,glu,iset) 
      call jeppe2(imem,xlog,qsqlog,nx,nq,xxl,qql,cc4,usea,iset) 
      call jeppe2(imem,xlog,qsqlog,nx,nq,xxl,qql,cc6,str,iset) 
      call jeppe2(imem,xlog,qsqlog,nx,nq,xxl,qql,cc8,dsea,iset) 
      call jeppe2(imem,xlog,qsqlog,nx,nq,xxl,qql,cc9,photon,iset) 
                                                                        
      chm=0.d0 
      if(qsq.gt.emc2) then 
      call jeppe2(imem,xlog,qsqlog,nx,nqc,xxl,qqlc,ccc,chm,iset) 
      endif 
                                                                        
      bot=0.d0 
      if(qsq.gt.emb2) then 
      call jeppe2(imem,xlog,qsqlog,nx,nqb,xxl,qqlb,ccb,bot,iset) 
      endif 
